import { reactive, hasInjectionContext, getCurrentInstance, version, inject, ref, watchEffect, watch, unref, toRef, isRef, isShallow, isReactive, toRaw, h, isReadonly, defineComponent, useSSRContext, onServerPrefetch, computed, toRefs, mergeProps, provide, onErrorCaptured, createVNode, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
import { ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderAttr, ssrRenderClass, ssrRenderAttrs, ssrRenderList, ssrLooseContain, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const main_vue_vue_type_style_index_0_scoped_a599775b_lang = "";
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-6d6f6096.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-c6bb20cc.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
